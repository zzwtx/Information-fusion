...
EXTRA_OPTS="${@:5}"                       # Extra yacs opts, e.g. TRAINER.FEDMGP.GROUP_BIND_SELECTION True
...
DIR=output/${DATASET}/${trainer}/${cfg_file}${run_tag}/${SHOTS}shots/seed${SEED}/${SUBSAMPLE_CLASSES}
