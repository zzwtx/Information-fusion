...
EXTRA_OPTS="${@:6}"                       # Extra yacs opts, e.g. TRAINER.FEDMGP.TCVP_ENABLED True

DATA="${COOP_DATASET:-$(pwd)/DATA}"       # Dataset root path
...
BASE_DIR=output/${DATASET}/${trainer}/${cfg_file}${run_tag}/${SHOTS}shots/seed${SEED}/base

# Test output path
OUTPUT_DIR=output/${DATASET}/${trainer}/${cfg_file}${run_tag}/${SHOTS}shots/seed${SEED}/${SUBSAMPLE_CLASSES}_test
