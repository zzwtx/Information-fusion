...
# Check arguments
if [ $# -lt 2 ]; then
    echo "Usage: $0 <MODEL_TYPE> <GPU_ID>"
    echo "Supported models: FedOPT, FedTPG, PromptFolio, FedPGP"
    exit 1
fi

MODEL_TYPE=$1
GPU=$2
CONFIG_FILE="base2novel_vit_b16"

# Validate model type
VALID_MODELS=("FedOPT" "FedTPG" "PromptFolio" "FedPGP" )
VALID_MODEL=false
...
SHOTS_LIST=(16)
DATASETS=("ucf101" "fgvc_aircraft" "stanford_cars")
...
echo "====================================================="
echo "Starting training and testing on group1 datasets"
...
echo ""
echo "====================================================="
echo "Group1 datasets completed"
echo "====================================================="
