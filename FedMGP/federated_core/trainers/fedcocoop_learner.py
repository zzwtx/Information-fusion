# federated_core/trainers/fedcocoop_learner.py
...
class FedCoCoOpLearner(BaseFederatedLearner):
    """FedCoCoOp implementation with standard full parameter aggregation."""
    ...
    def update_client_models(self, client_ids: List[int],
        ...
        for client_id in all_clients:
            ...
            print(f"Client {client_id} FedCoCoOp update completed")
