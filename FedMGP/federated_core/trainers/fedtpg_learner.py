# federated_core/trainers/fedtpg_learner.py
...
class FedTPGLearner(BaseFederatedLearner):
    """FedTPG implementation with standard full parameter aggregation."""
    ...
    def update_client_models(self, client_ids: List[int],
        ...
        for client_id in all_clients:
            ...
            print(f"Client {client_id} FedTPG update completed")
