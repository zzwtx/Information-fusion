# federated_core/trainers/vpt_learner.py
...
class VPTLearner(BaseFederatedLearner):
    """VPT implementation with standard full parameter aggregation."""
    ...
    def update_client_models(self, client_ids: List[int],
        ...
        for client_id in all_clients:
            ...
            print(f"Client {client_id} VPT update completed")
